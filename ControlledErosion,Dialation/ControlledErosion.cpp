...
//The program erodes the pixels of our image that aligns with the black region of the control image
...
int main(int argc, char *argv[])
{
	...
	//	printControlMAtrix();
		...
		*/
		...
		fstream myfile;
		myfile.open("out.ppm", ios::out | ios::trunc | ios::binary);
	...
	glutCreateWindow("Controlled Erosion");
	init();
